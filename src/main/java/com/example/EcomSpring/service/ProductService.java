...
public class ProductService {
    ...
    public Product getProductById(int id) {return repo.findById(id).orElse(new Product(-1));
    }
    ...
    public List<Product> searchProducts(String keyword) {
        return repo.findByNameContainingOrDescriptionContainingOrBrandContainingOrCategoryContaining(keyword, keyword, keyword, keyword);
    }
}
